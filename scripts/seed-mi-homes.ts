  ...
  developments: [
    {
      ...
      totalLots: 120,
      plans: [
        { name: 'Ashton', sqft: 2850, bedrooms: 4, bathrooms: 3.5, garageSize: 2, basementType: 'walkout' },
        { name: 'Barrington', sqft: 3100, bedrooms: 5, bathrooms: 4, garageSize: 3, basementType: 'walkout' },
    ...
    },
    {
      ...
      totalLots: 85,
      plans: [
        { name: 'Devon', sqft: 2650, bedrooms: 4, bathrooms: 3, garageSize: 2, basementType: 'standard' },
        { name: 'Easton', sqft: 3300, bedrooms: 5, bathrooms: 4.5, garageSize: 3, basementType: 'walkout' },
      ],
    },
    {
      name: 'Oneka Shores',
      ...
      totalLots: 95,
      plans: [
        { name: 'Fairfield', sqft: 2750, bedrooms: 4, bathrooms: 3, garageSize: 2, basementType: 'walkout' },
        { name: 'Georgetown', sqft: 2950, bedrooms: 4, bathrooms: 3.5, garageSize: 3, basementType: 'walkout' },
      ],
    },
    {
      name: 'Amber Fields - The Enclave',
      city: 'Otsego',
      state: 'MN',
      zipCode: '55330',
      lat: 45.2744,
      ...
      totalLots: 65,
      plans: [
        { name: 'Hamilton', sqft: 2500, bedrooms: 3, bathrooms: 2.5, garageSize: 2, basementType: 'standard' },
        { name: 'Ivy Ridge', sqft: 2850, bedrooms: 4, bathrooms: 3.5, garageSize: 2, basementType: 'walkout' },
      ],
    },
    {
      ...
      totalLots: 75,
      plans: [
        { name: 'Juniper', sqft: 2350, bedrooms: 3, bathrooms: 2.5, garageSize: 2, basementType: 'standard' },
        { name: 'Kendall', sqft: 2650, bedrooms: 4, bathrooms: 3, garageSize: 2, basementType: 'standard' },
      ],
    },
  ],
