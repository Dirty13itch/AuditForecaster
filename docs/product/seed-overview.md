...
- **House Volume:** Calculated as floor area × 8 ft ceiling height
...
3. **Inspector Assignment**
   ...
   - Even-indexed jobs → Inspector 1
   - Odd-indexed jobs → Inspector 2
...
### Data Integrity
- ✅ All jobs linked to valid lots, plans, builders
- ✅ All completed jobs have test data (blower door, duct, ventilation, forecast)
- ✅ All tests linked to valid jobs
- ✅ All users, builders, CMs properly referenced
- ✅ No orphaned records
...
```
🌱 Starting M/I Homes Twin Cities seed...
✅ Organization created: Ulrich Energy Auditing
✅ Users created: 3
✅ Builder created: M/I Homes
✅ Builder contacts created: 2
✅ Construction managers created: 3
✅ Developments created...
   📍 Development: Rush Hollow North (Maple Grove)
   📐 Plans created: 3
   🏘️ Lots created: 10
   📋 Jobs created: 7
✅ Total jobs created: 35
✅ Total visits with test data: 15
✅ Photos created: 15
✅ QA inspection scores created: 5
✅ 45L tax credit projects created: 2
...
- Complete scheduled jobs → done status
